...
6. **Mobile polish pass v1** against the 03 Screens mobile frames — shipped
   ...
   Document review source/action/bottom-nav safety, Properties default compact
   mobile board fidelity, and Smart Intake landing-first mobile fidelity. Work
   mobile toast bottom-nav clearance is included as a follow-up under the same
   Remba-pending polish umbrella.
