...
- [ ] Continue Xero from dispatch receipts into full accounting reconciliation guardrails, explicit retry history filters, contact/invoice sync exception queues, and payment reconciliation review surfaces.
