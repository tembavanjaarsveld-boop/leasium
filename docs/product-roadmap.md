...
- [ ] Continue AI apply beyond first-pass register workflows: add richer acquisition schedule blockers, option/security task generation, and expand billing drafts toward approval-ready invoice generation.
