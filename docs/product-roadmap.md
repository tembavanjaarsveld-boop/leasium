...
- [ ] Continue Operations polish with deeper maintenance invoice exception recovery, contractor retry/recovery states, and clearer handoff between contractor updates, job completion, and Billing Readiness.
