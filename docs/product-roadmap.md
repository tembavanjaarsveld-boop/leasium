...
- [x] Smart Intake acquisition tenancy schedule v1: purchase contracts can extract reviewed schedule rows, create/link multiple units, and preserve tenant/rent/lease facts on unit provenance metadata without automatically creating tenant or lease records.
...
- [ ] Continue AI apply beyond first-pass register workflows: promote reviewed acquisition tenancy schedules into tenant/lease drafts and expand billing drafts toward approval-ready invoice generation.
