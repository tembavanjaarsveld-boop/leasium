...
- [ ] Continue AI apply beyond first-pass register workflows: add richer acquisition schedule blockers, outgoings/other charge draft creation from reviewed rows, and expand billing drafts toward approval-ready invoice generation.
