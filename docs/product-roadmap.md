...
- [ ] Continue Xero from provider payment review into explicit retry history filters, contact/invoice sync exception queues, bank-feed reconciliation depth, and accounting snapshot guardrails.
