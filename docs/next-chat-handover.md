...
1. **Operations polish** — owner/tenant-facing completion review paths, clearer row density at small viewports, and Remba review of the new inline-edit undo toast + activity audit strip. Daily-driver surface, high leverage.
