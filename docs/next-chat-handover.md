...
- Operations queue document-intake rows now link to `/intake?review=<id>`, so tenant-uploaded insurance review work opens the exact Smart Intake item instead of the generic intake workspace.
