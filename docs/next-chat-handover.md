...
1. **Operations polish** — deeper activity/audit presentation on the work-order detail page, owner/tenant-facing completion review paths, clearer row density at small viewports, and Remba review of the new inline-edit undo toast. Daily-driver surface, high leverage.
