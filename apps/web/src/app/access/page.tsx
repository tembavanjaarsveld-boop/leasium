        ...
        <form className="mt-5 grid gap-3" onSubmit={submit}>
          <label className="grid gap-1.5 text-sm">
            ...
            <input
              ...
              autoFocus
              className="min-h-11 w-full rounded-xl border border-border bg-white px-3 text-sm outline-none transition duration-200 ease-leasium focus:border-primary focus:ring-2 focus:ring-primary/15"
