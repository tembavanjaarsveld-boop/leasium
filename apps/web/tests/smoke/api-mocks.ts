...
const initialComplianceChecks = [
  ...
  },
  {
    ...
    lease_id: leaseId,
    assigned_user_id: assigneeId,
    source_document_id: "document-compliance-lift-1",
    current_obligation_id: "obligation-compliance-3",
    title: "Lift registration certificate",
    kind: "other",
    status: "active",
    jurisdiction: "QLD",
    authority: "Safe Work Queensland",
    recurrence_interval: 1,
    recurrence_unit: "years",
    last_checked_at: "2025-05-01T00:00:00.000Z",
    next_due_date: "2026-06-30",
    certificate_expires_on: "2026-06-04",
    certificate_expiry_status: "expired",
    days_until_certificate_expiry: -5,
    owner_role: "ops",
    notes: "Lift registration certificate lapsed; renewal in progress.",
    metadata: {
      evidence_history: [
        {
          document_id: "document-compliance-lift-1",
          added_at: "2025-05-01T01:00:00.000Z",
          actor: "ops@example.test",
        },
      ],
      completion_history: [],
...
const rentRoll = [
  ...
  // Rent-roll-only rows (no lease/tenant) that seed the rent-roll billing
  // blocker group with multiple distinct reasons at different counts, without
  // creating onboarding prep rows. Used by the reason-breakdown smoke assertions.
  {
    entity_id: entityId,
    entity_name: "Acme Holdings Pty Ltd",
    property_id: propertyId,
    property_name: "Queen Street Retail Centre",
    tenancy_unit_id: "unit-blocked-1",
    unit_label: "Shop 4",
    lease_id: null,
    tenant_id: null,
    tenant_name: null,
    ...
    gst_readiness_blockers: [],
    xero_readiness_blockers: [],
    invoice_readiness_blockers: ["Tenant is missing a billing email."],
  },
  {
    entity_id: entityId,
    entity_name: "Acme Holdings Pty Ltd",
    property_id: propertyId,
    property_name: "Queen Street Retail Centre",
    tenancy_unit_id: "unit-blocked-2",
    unit_label: "Shop 5",
    lease_id: null,
    tenant_id: null,
    tenant_name: null,
  ...
  },
  {
    ...
    property_id: siblingPropertyId,
    property_name: "Queen Street Warehouse",
    tenancy_unit_id: "unit-blocked-3",
    ...
    next_due_date: null,
    gst_readiness_blockers: [],
    xero_readiness_blockers: ["Rent is missing a Xero account code."],
    invoice_readiness_blockers: [],
  },
];
...
const initialDocumentIntakes = [
  {
    ...
    extracted_data: {
      ...
      source_preview: {
        page: 3,
        page_count: 24,
        citation: "Clause 4.1 and Schedule 2",
        highlight_text:
          "Bright Cafe Pty Ltd leases Shop 3 at Queen Street Retail Centre from 1 July 2025.",
      },
      parties: [
        {
          ...
          role: "tenant",
          confidence: 0.98,
          source_hint: "Parties schedule",
          page: 3,
          citation: "Tenant name",
        },
      ],
      properties: [
        {
          ...
          unit_label: "Shop 3",
          confidence: 0.94,
          source_hint: "Schedule 1",
          page: 2,
          citation: "Premises schedule",
        },
      ],
      key_dates: [
        {
          ...
          date: "2025-07-01",
          confidence: 0.99,
          source_hint: "Clause 2.1",
          page: 3,
          citation: "Commencement date",
        },
        {
          label: "Expiry",
          date: "2028-06-30",
          confidence: 0.98,
          source_hint: "Clause 2.2",
          page: 3,
          citation: "Expiry date",
        },
        {
          label: "Rent review",
          date: "2026-07-01",
          confidence: 0.91,
          source_hint: "Clause 5.3",
          page: 7,
          citation: "Annual review date",
        },
      ],
      money_amounts: [
        {
      ...
      obligations: [
        {
          ...
          summary: "1 x 3 years - exercise by 28 Jun 2026",
          confidence: 0.71,
          source_hint: "Clause 9.1",
          page: 11,
          citation: "Option exercise notice",
        },
        {
          title: "Outgoings",
          due_date: "2025-07-01",
          category: "outgoings",
          summary: "Single holding - 100% recovery",
          confidence: 0.64,
          source_hint: "Clause 6.2",
          page: 5,
          citation: "Outgoings recovery",
        },
        {
          title: "Bond",
          due_date: "2025-07-01",
          category: "security",
          summary: "$9,750 bank guarantee",
          confidence: 0.95,
          source_hint: "Clause 8.1",
          page: 8,
          citation: "Security deposit",
        },
      ],
  ...
  {
    id: "intake-inbound-email-attachment-1",
    entity_id: entityId,
    document_id: "document-inbound-email-attachment-1",
    status: "ready_for_review",
    document_type: "insurance_certificate",
    ...
    openai_response_id: "resp-inbound-attachment-smoke",
    error_message: null,
    reviewed_at: null,
    reviewed_by_user_id: null,
    applied_at: null,
  ...
  {
    id: "intake-tenant-upload-insurance-1",
    entity_id: entityId,
    document_id: "tenant-upload-insurance-document-1",
    status: "ready_for_review",
    document_type: "insurance_certificate",
    summary: "Tenant-uploaded insurance certificate expires 2027-02-28.",
    confidence: 0.91,
    extracted_data: {
      document_type: "insurance_certificate",
      summary: "Tenant-uploaded insurance certificate expires 2027-02-28.",
    ...
    review_data: {
      ...
      lease_id: leaseId,
      guardrail:
        "Tenant-uploaded documents are promoted for operator review. No lease status, tenant metadata, provider action, or payment record is changed until an operator applies the review.",
    },
    openai_response_id: "resp-tenant-upload-insurance-smoke",
    error_message: null,
    reviewed_at: null,
    reviewed_by_user_id: null,
    applied_at: null,
...
export async function mockLeasiumApi(
  ...
  const insightsOverview = () => {
    ...
    return {
        ...
        next_items: [
          {
            ...
            register_check_id: "register-check-1",
            last_completed_at: "2026-05-11T01:02:03.000Z",
            last_completed_by: "ops@example.test",
            operator_approved_evidence: true,
            rank: -9,
          },
          {
            ...
            register_check_id: null,
            last_completed_at: null,
            last_completed_by: null,
            operator_approved_evidence: false,
            rank: 13,
          },
        ],
      },
      maintenance_snapshot: {
        ...
        contractor_assigned_count: 2,
        aged_14_day_count: 1,
        oldest_age_days: 21,
        status_counts: { requested: 1, assigned: 1 },
        priority_counts: { urgent: 1, normal: 1 },
        next_items: [
          {
            id: "work-order-1",
            ...
            due_date: "2026-05-15",
            chip: "4d overdue",
            href: "/operations/maintenance/work-order-1",
            property_id: propertyId,
            property_name: "Queen Street Retail Centre",
            tenancy_unit_id: unitId,
            unit_label: "Shop 3",
          ...
          },
          {
            ...
            due_date: "2026-05-28",
            chip: "In 9d",
            href: "/operations/maintenance/work-order-2",
            property_id: propertyId,
            property_name: "Queen Street Retail Centre",
            tenancy_unit_id: unitId,
            unit_label: "Shop 3",
      ...
      arrears_snapshot: {
        ...
        dispute_counts: { raised: 1 },
        escalation_counts: { none: 1 },
        next_items: [
          {
            id: "arrears-1",
            title: "Bright Cafe Pty Ltd arrears",
            status: "active",
            currency: "AUD",
            as_of: "2026-05-19",
            total_balance_cents: 880000,
            ...
            oldest_unpaid_invoice_date: "2026-05-01",
            age_days: 18,
            next_reminder_on: "2026-05-18",
            chip: "1d overdue",
            href: "/operations?tab=arrears&case_id=arrears-1",
            property_id: propertyId,
            property_name: "Queen Street Retail Centre",
            tenancy_unit_id: unitId,
            unit_label: "Shop 3",
      ...
      invoice_status_snapshot: {
        ...
        approved_count: 2,
        approved_unsynced_count: 2,
        ready_to_send_count: 2,
        sent_count: 0,
        unpaid_count: 2,
        overdue_count: 2,
        xero_failed_count: 1,
        ...
        payment_status_counts: { unpaid: 2 },
        delivery_status_counts: { ready: 2 },
        posting_status_counts: {
          approved_not_synced: 1,
          provider_failed: 1,
        },
        next_items: [
          {
            ...
            posting_status: "provider_failed",
            chip: "3d overdue",
            href: "/billing-readiness?tab=delivery&filter=needs_action&invoice_id=invoice-draft-failed",
            property_id: propertyId,
            property_name: "Queen Street Retail Centre",
            tenancy_unit_id: unitId,
            unit_label: "Shop 3",
          ...
          },
          {
            ...
            payment_status: "unpaid",
            delivery_status: "ready",
            posting_status: "approved_not_synced",
            chip: "4d overdue",
            href: "/billing-readiness?tab=delivery&filter=ready_dispatch&invoice_id=invoice-draft-1",
            property_id: propertyId,
            property_name: "Queen Street Retail Centre",
            tenancy_unit_id: unitId,
            unit_label: "Shop 3",
  ...
  await page.route("**/api/v1/**", async (route) => {
    ...
    if (method === "GET" && path === "/comms/queue") {
      await fulfillJson(route, {
        ...
        candidates: [
          ...
          {
            id: "comms-inbound-email-attachment-1",
            kind: "inbound_email",
            target_kind: "inbound_message",
            target_id: "inbound-email-attachment-1",
            tenant_id: tenantId,
            tenant_name: "Bright Cafe Pty Ltd",
            property_name: "Queen Street Retail Centre",
            unit_label: "Shop 3",
            recipient_email: "attachments@tenant.example",
            recipient_phone: null,
            subject: "Re: Lease attachment",
            body: "Hi Bright Cafe team,\n\nThanks for sending the attachment. We have routed it to Smart Intake for review and will follow up shortly.\n\nThanks,\nThe property team",
            severity: "info",
            due_at: null,
            detail: "1 attachment routed to Smart Intake",
            generated_at: "2026-05-27T02:00:00.000Z",
          },
          {
    ...
    if (method === "GET" && path === "/comms/inbound-messages") {
    ...
    if (method === "GET" && path === "/calendar/events") {
      ...
      const calendarEvents = [
        {
          id: "lease-expiry-lease-1",
          type: "lease_expiry",
          title: "Queen Street lease expiry",
          date: "2026-07-20",
          severity: "warning",
          entity_id: entityId,
          property_id: propertyId,
          ...
          tenant_id: tenantId,
          lease_id: leaseId,
          source: { table: "leases", id: leaseId },
          link: `/properties?entity_id=${entityId}&property_id=${propertyId}&view=calendar`,
          chip: "Lease expiry",
          description: "Bright Cafe lease reaches its expiry date.",
        },
        {
          id: "rent-review-lease-1",
          type: "rent_review",
          title: "Queen Street rent review",
          date: "2026-07-01",
          severity: "primary",
          entity_id: entityId,
          property_id: propertyId,
          ...
          link: `/properties?entity_id=${entityId}&property_id=${propertyId}&view=calendar`,
          chip: "Rent review",
          description: "Next commercial rent review date.",
        },
        {
          id: "maintenance-due-work-order-1",
          type: "maintenance_due",
          title: maintenanceWorkOrders[0].title,
          date: maintenanceWorkOrders[0].due_date,
          severity: "danger",
          entity_id: maintenanceWorkOrders[0].entity_id,
          property_id: maintenanceWorkOrders[0].property_id,
          tenancy_unit_id: maintenanceWorkOrders[0].tenancy_unit_id,
          tenant_id: maintenanceWorkOrders[0].tenant_id,
          lease_id: maintenanceWorkOrders[0].lease_id,
          source: { table: "maintenance_work_orders", id: "work-order-1" },
          link: "/operations/maintenance/work-order-1",
          chip: "Maintenance",
          description: maintenanceWorkOrders[0].description,
        },
        {
          id: "compliance-check-compliance-check-fire-1",
          type: "compliance_due",
          title: "Annual fire safety statement",
          date: "2026-05-10",
          severity: "danger",
        ...
        },
        {
          ...
          tenant_id: tenantId,
          lease_id: leaseId,
          source: { table: "invoice_drafts", id: "invoice-draft-1" },
          link: "/money",
          chip: "Invoice",
          description: "Approved invoice due date.",
        },
        {
          id: "arrears-reminder-arrears-1",
          ...
          tenant_id: tenantId,
          lease_id: leaseId,
          source: { table: "arrears_cases", id: "arrears-1" },
          link: "/operations?tab=arrears",
          chip: "Arrears",
          description: "Next reminder date for the active arrears case.",
        },
        {
          id: "tenant-onboarding-onboarding-1",
          type: "tenant_onboarding",
          title: "Tenant onboarding",
          date: tenantOnboardings[0].due_date,
          severity: "warning",
          entity_id: tenantOnboardings[0].entity_id,
          property_id: propertyId,
          tenancy_unit_id: unitId,
          tenant_id: tenantId,
          lease_id: tenantOnboardings[0].lease_id,
          source: { table: "tenant_onboardings", id: "onboarding-1" },
          link: "/tenants",
          chip: "Onboarding",
          description: "Waiting tenant onboarding due date.",
        },
        {
          id: "secondary-rent-review-lease-99",
          type: "rent_review",
          title: "Rivergum annual review",
          date: "2026-07-08",
          severity: "primary",
          entity_id: secondaryEntityId,
          ...
          tenancy_unit_id: null,
          tenant_id: null,
          lease_id: "lease-secondary-1",
          source: { table: "leases", id: "lease-secondary-1" },
          link: `/properties?entity_id=${secondaryEntityId}&property_id=property-secondary-1&view=calendar`,
          chip: "Rent review",
          description: "Cross-entity calendar fixture.",
        },
      ];
      await fulfillJson(
        route,
        calendarEvents.filter(
          (event) =>
            event.date >= from &&
            event.date <= to &&
            (!hasEntityId || event.entity_id === requestedEntityId),
        ),
      );
      return;
    }
