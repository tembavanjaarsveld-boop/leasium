...
class BrandedTemplateVersionCreate(BaseModel):
    """Snapshot edits as the next version; omitted fields inherit the source row."""
...
class BrandedTemplateRenderPreviewRead(ApiModel):
    entity_id: UUID
    key: str
    channel: BrandedTemplateChannel
    subject: str | None
