...
def _statement_pack_zip_bytes(
    ...
    with zipfile.ZipFile(buffer, mode="w", compression=zipfile.ZIP_DEFLATED) as archive:
        ...
        if self_managed:
            readme = (
                "Review-only entity statement pack generated by Relby.\n"
            ...
            readme = (
                "Review-only owner statement pack generated by Relby.\n"
                f"Month: {statements.month}\n"
...
def mark_owner_distribution_disbursed(
    ...
    disbursed the net amount to the owner outside Relby (e.g. via their own
